...
// export default function CallButton({ peer, onlineUsers }) {
...
//     getRemoteStream,
//     callState,
//   } = useCall(user._id, onlineUsers);

//   const localRef = useRef(null);
//   const remoteRef = useRef(null);
//   const [timer, setTimer] = useState(0);

//   const isOnline = onlineUsers.includes(peer._id);
...
//           style={{
//             ...buttonStyle,
//             background: isOnline ? "#4caf50" : "#aaa",
//             color: "#fff",
//             width: 60,
//             height: 60,
//             borderRadius: "50%",
...
//           }}
//           onClick={() => isOnline && call(peer._id)}
//           title={isOnline ? `Call ${peer.username}` : `${peer.username} is offline`}
//         >
//           📞
//         </button>
//       )}
